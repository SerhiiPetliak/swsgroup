    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar_position">
                ...
                <li><a href="#aboutus" class="nav-link waves-effect waves-light ancLinks bold_text">About</a></li>
                <li><a href="#portolio" class="nav-link waves-effect waves-light ancLinks bold_text">Portfolio</a></li>
                <li><a href="#contacts" class="nav-linkwaves-effect waves-light ancLinks bold_text">Contacts</a></li>
            </ul>
        </div><!-- /.nav-collapse -->
    </div><!-- /.container -->
</nav><!-- /.navbar -->